      ...
      render: (_, record) => (
        <>
          ...
          <Popconfirm
            ...
            onConfirm={() => deleteRepa(record.id)}
          >
            <Button
              type="danger"
              ...
              extra={
                <>
                  <Button
                    ...
                    onClick
                  >
                    <Link to={"/addRepa"}>{plus}Ajouter</Link>
                  </Button>
                  <Popconfirm
